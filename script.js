window.onload = function () {
    ...
    imageHead.src = "snake_head-transformed.png";
    ...
    function handleTouchMove(e) {
        ...
        // Reset touch start position for next move
    ...
    function gameOver() {
        ...
        ctx.strokeText("Toucher pour rejouer (espace ou clic gauche sur PC).", centreX, centreY - 120);
        ctx.fillText("Toucher pour rejouer (espace ou clic gauche sur PC).", centreX, centreY - 120);
        ctx.restore();
    }
    ...
    function Snake(body, direction) {
        ...
        this.imageBody.src = 'snake_body.jpg';
